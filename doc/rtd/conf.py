...
import os
import sys
sys.path.insert(0, os.path.abspath('../../tools/CGMFtk/'))
...
copyright = '2020, CGMF Development Team, LANL'
author = 'P.Talou, I.Stetcu, P.Jaffke, M.E.Rising, A.E.Lovell, T.Kawano'
